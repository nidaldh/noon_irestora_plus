...
class Setting extends Cl_Controller {
    ...
    public function invoicePrinterSetting($id = '') {
        ...
        if (htmlspecialcharscustom($this->input->post('submit'))) {
            ...
            $outlet_info['print_server_url_invoice'] = trim_checker(htmlspecialcharscustom($this->input->post('print_server_url_invoice')));
    ...
    public function billPrinterSetting($id = '') {
        ...
        if (htmlspecialcharscustom($this->input->post('submit'))) {
            ...
            $outlet_info['print_server_url_bill'] = trim_checker(htmlspecialcharscustom($this->input->post('print_server_url_bill')));
            if ($id == "") {
                $this->Common_model->insertInformation($outlet_info, "tbl_companies");
                $this->session->set_flashdata('exception', lang('insertion_success'));
            } else {
    ...
    public function KOTPrinterSetting($id = '') {
        ...
        if (htmlspecialcharscustom($this->input->post('submit'))) {
            ...
            $outlet_info['print_server_url_kot'] = trim_checker(htmlspecialcharscustom($this->input->post('print_server_url_kot')));
