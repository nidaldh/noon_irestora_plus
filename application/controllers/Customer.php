                ...
                if ($this->upload->do_upload('userfile')) {
                    ...
                    if ($totalrows < 54) {
                        ...
                        for ($i = 4; $i <= $totalrows; $i++) {
                            ...
                            $phone = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(1, $i)->getValue()));
                            $email = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(2, $i)->getValue()));
                            $dob = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(3, $i)->getValue()));
                            $doa = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(4, $i)->getValue()));
                            $delivery_address = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(5, $i)->getValue()));
                        ...
                        if ($arrayerror == '') {
                            ...
                            for ($i = 4; $i <= $totalrows; $i++) {
                                ...
                                $doa = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(4, $i)->getValue()));
                                $delivery_address = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(5, $i)->getValue()));
                                $default_discount = htmlspecialcharscustom(trim($objWorksheet->getCellByColumnAndRow(6, $i)->getValue()));
