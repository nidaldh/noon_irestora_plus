        ...
        <div class="table-box">
                ...
                <div class="row">
                    <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                        <div class="form-group">
                            <label> <?php echo lang('sos_enable_online_order'); ?>  <div class="tooltip_custom">
                                    <i data-bs-toggle="tooltip" data-bs-placement="top" title="<?php echo lang('sos_online_order_tooltip'); ?>" data-feather="help-circle"></i>
                                </div></label>
            ...
            <div class="row py-2">
                ...
                <div class="col-sm-12 col-md-2 mb-2">
                    ...
                    <a class="btn bg-blue-btn w-100" href="<?php echo base_url() ?>setting/onlineOrderURL">
