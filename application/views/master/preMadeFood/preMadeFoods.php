                            ...
                            <td class="ir_txt_center">
                                <div class="btn-group  actionDropDownBtn">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton1" role="menu">
                                        <li data-access="update-325" class="menu_assign_class"><a
                                                    href="<?php echo base_url() ?>preMadeFood/addEditPreMadeFood/<?php echo escape_output($this->custom->encrypt_decrypt($ingrnts->id, 'encrypt')); ?>"><i
                                                        class="fa fa-pencil tiny-icon"></i><?php echo lang('edit'); ?></a></li>
                                        <li data-access="delete-325" class="menu_assign_class"><a class="delete"
                                               href="<?php echo base_url() ?>preMadeFood/deletePreMadeFood/<?php echo escape_output($this->custom->encrypt_decrypt($ingrnts->id, 'encrypt')); ?>"><i
